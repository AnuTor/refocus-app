...
Survey cerq(int id) {
  return Survey(
    ...
    questions: [
      Question(
          id: 1, question: 'Pienso que tengo que aceptar que esto sucedió'),
      Question(
          id: 2, question: 'Siento que otros son los culpables de lo que pasó'),
      Question(
          id: 3,
      ...
      Question(
          id: 4,
          question:
              'Pienso que otras personas pasan experiencias mucho peores'),
      Question(
          id: 5, question: 'Pienso cómo puedo afrontar mejor la situación'),
      Question(
          id: 6,
          question:
      ...
      Question(id: 8, question: 'Pienso que tengo que aceptar la situación'),
      Question(
          id: 9,
      ...
      Question(
          id: 14, question: 'Siento que otros son responsables de lo que pasó'),
      Question(
          id: 15,
          question:
              'Planifico qué es lo mejor que puedo hacer en esta situación'),
      Question(id: 16, question: 'Le busco el lado positivo al asunto'),
      Question(
          id: 17,
          question:
      ...
      Question(
          id: 18,
          question:
              'Constantemente pienso en lo horrible que fue la situación'),
    ],
  );
}
