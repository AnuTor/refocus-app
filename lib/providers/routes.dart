...
class Routes with ChangeNotifier {
  ...
  final List<Path> _items = [
    Path(
      ...
      title: 'Relajación',
      subtitle: 
        'Técnicas que te ayudarán a alcanzar un estado emocional de '
    ...
    Path(
      ...
      subtitle: 'Técnicas para lograr un pensamiento más equilibrado, refocalizar y buscar interpretaciones alternativas.',
  ...
  void fetchdata() async {
    ...
    await FirebaseFirestore.instance
      ...
      _items[1].startdate = DateUtils.dateOnly(_userStartdate).add(const Duration(days: 7));
      notifyListeners();
    });
  }
